...
#db to display .........
$sql3="SELECT id, type ,percantage from config WHERE `email` = '$email' and course = '$cid'";
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow">
                        <div class="card-header py-3" style="background: var(--bs-link-hover-color);">
                            <p class="text-primary m-0 text-warning fw-bold">Manage conigurations</p>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                    ...
                                    <?php
                                       ...
                                       ?>
                                        <tr>
                                            ...
                                            <td><input type="text" style="border: none; width: 100px;" name="name" value="<?php echo $row3 -> type ;?>"></td>
                                            <td><input type="text" name="reg"style="border: none; width: 100px;" value="<?php echo $row3 -> percantage ;?>" ></td>
                            ...
                            <div class="row">
                                ...
                                <form method="post"><div class="col-md-6" style="text-align: center;"><button class="btn btn-primary" type="submit" name="discard">Back To Configurations</button></div></form>
                            </div>
                        </div>
                    </div>
                </div>
