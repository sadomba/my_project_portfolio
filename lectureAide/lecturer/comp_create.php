...
$sql1 ="SELECT `type` FROM `config` WHERE email = '$email'  AND course = '$cid'";
...
$sql="insert into test(title,c_id,points,l_email,type)values(:title,:c_id,:points,:email,:type)";
$query=$dbh->prepare($sql);
$query->bindParam(':title',$title,PDO::PARAM_STR);
$query->bindParam(':c_id',$cid,PDO::PARAM_STR);
...
$sql2 = "ALTER TABLE `$cid` ADD `$title` INT(20); INSERT INTO `marks` (`id`, `title`, `email`, `course`) VALUES (NULL, '$title', '$email', '$cid') ;";
$query2 = $dbh -> prepare($sql2);
$query2 -> execute();
    echo '<script>alert("component has been created.")</script>';
...
<div id="wrapper"  style="background-image: url(../assets/img/image3.jpeg);">                                                                                                                           
      ...
      <li class="breadcrumb-item active">Component creation</li>
    </ol>
    ...
    <div class="row">
                        <div class="col">
                                                    ...
                                                    <div class="col-md-8 col-lg-10 col-xl-5 col-xxl-4" style="width: 700.5px;">
                                                        <div class="card mb-5">
                                                            <div class="card-body p-sm-5" style="background:blue;width: 600.5px;">
                                                                <h2 class="text-center mb-4 text-warning">Create component For : <?php echo $cid?></h2>
                                                                <form method="post">
                                                                    <div class="mb-3"><input class="form-control text-black form-control-user" required  name="title" placeholder="Component title" ></div>
                                                                    <div class="mb-3"><input class="form-control text-black form-control-user" required type="number"  name="points" placeholder="Points"></div>
                                                                    
                                                                  
                                                                    <div class="mb-3"><select class="form-control text-black form-control-user" name="type" placeholder="Email" required>
                            ...
                            { 
                                    ...
                                    <div class="mb-3"><button class="btn btn-warning" type="submit" name="save">Save</button></div></form>
                                    <hr>    <form method="post">               
                                    <div class="mb-3"><button class="btn btn-warning" type="submit" name="back">Back to conponents</button></div>                     
