                    ...
                    <div class="container">
                        <div class="p-5">
                            <div class="text-center">
                                <h4 class="text-dark mb-4">Create a new user Account!</h4>
                            </div>
                            <form class="user">
                                <div class="row mb-3">
                                ...
                                <div class="mb-3"> <select class="form-control form-control-user" name="email" placeholder="Email" onchange="doReload(this.value);" >
