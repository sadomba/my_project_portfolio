...
<?php
    $pageTitle = "Edit Permission"; //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Edit Permission</div>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-permission-holder" class=" ">
                                            <input id="ctrl-permission" data-field="permission"  value="<?php  echo $data['permission']; ?>" type="text" placeholder="Enter Permission"  required="" name="permission"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
