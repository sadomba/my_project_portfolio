...
<?php
    $pageTitle = "Edit Property"; //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Edit Property</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("property/edit/$rec_id"); ?>" method="post">
                        <!--[form-content-start]-->
                        @csrf
                        <div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-category-holder" class=" ">
                                            <input id="ctrl-category" data-field="category"  value="<?php  echo $data['category']; ?>" type="text" placeholder="Enter Category"  required="" name="category"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-count-holder" class=" ">
                                            <input id="ctrl-count" data-field="count"  value="<?php  echo $data['count']; ?>" type="number" placeholder="Enter Count" step="any"  required="" name="count"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-cost-holder" class=" ">
                                            <input id="ctrl-cost" data-field="cost"  value="<?php  echo $data['cost']; ?>" type="number" placeholder="Enter Cost" step="0.1"  name="cost"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
